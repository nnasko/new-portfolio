...
const ThreeHeroGlobe = dynamic(() => import('./components/ThreeHeroGlobe'), { ssr: false });
    ...
    <main className="min-h-screen relative">
      ...
      <Suspense fallback={<ComponentLoader />}>
        <SectionTransition>
          <section
            id="top"
            className="relative min-h-screen flex items-center px-4 md:px-6 lg:px-12 pt-20 md:pt-24 overflow-visible"
          >
            {/* Background moved to global layout to span the whole page */}
            <div className="max-w-7xl mx-auto w-full">
              <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center min-h-[60vh] lg:min-h-[70vh]">
                <div
                  className="max-w-4xl opacity-0 animate-fade-in"
                ...
                >
                  ...
                  <div
                    className="flex flex-col sm:flex-row gap-3 md:gap-4 lg:gap-6 text-sm mt-8 md:mt-12 opacity-0 animate-fade-in"
                ...
                {/* Globe visualization - hidden on mobile, shown on lg screens */}
                <div
                  className="hidden lg:flex items-center justify-center overflow-visible h-full min-h-[500px] opacity-0 animate-fade-in"
      ...
      {/* why choose me section - text left, photo right */}
      <Suspense fallback={<ComponentLoader />}>
        <SectionTransition delay={0.03}>
          <section id="why" className="py-16 md:py-24 px-4 md:px-6 lg:px-12">
            <div className="max-w-7xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
                ...
                <div className="flex justify-center lg:justify-end">
                  <div className="rounded-2xl overflow-hidden border border-neutral-300 dark:border-neutral-700 bg-neutral-100/40 dark:bg-neutral-800/40 p-1">
                    <Image
                      src="/me.png"
                      alt="Atanas Kyurkchiev"
                      width={320}
                      height={320}
                      className="w-48 h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 object-cover rounded-xl"
                    />
                  </div>
                </div>
              </div>
      ...
      {/* client stories section - text left, projects right */}
      <Suspense fallback={<ComponentLoader />}>
                  ...
                  {loading ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                      {projects.slice(0, 4).map((project, index) => (
                        <div key={project.id} className="opacity-0 animate-fade-in" style={{ animationDelay: `${0.4 + index * 0.1}s` }}>
                          {(() => {
                            ...
                            return (
                              <Link href={`/work/${slug}`} className="block group">
                                <div className="relative overflow-hidden rounded-lg border border-neutral-300 dark:border-neutral-700 bg-neutral-100/40 dark:bg-neutral-800/40 hover:scale-105 transition-transform duration-300">
                                  <Image
                                    src={project.image}
                                    alt={project.title}
                                    width={400}
                                  ...
                                  />
                                  <div className="p-4">
                                    <h3 className="text-sm md:text-base font-medium mb-1">{project.title}</h3>
        ...
        <SectionTransition delay={0.15}>
          <section className="py-16 md:py-24 px-4 md:px-6 lg:px-12 bg-neutral-100 dark:bg-neutral-800">
            <div className="max-w-4xl mx-auto text-center">
              <div
                className="mb-8 md:mb-12 opacity-0 animate-fade-in"
                style={{ animationDelay: "0.2s" }}
              >
                <AnimatedText
              ...
              <div
                className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center opacity-0 animate-fade-in"
                style={{ animationDelay: "0.6s" }}
              >
                <div className="hover:scale-105 transition-transform">
                  <Link
              ...
              <div
                className="mt-8 md:mt-12 text-center opacity-0 animate-fade-in"
        ...
        <SectionTransition delay={0.3}>
          ...
          >
            <div className="max-w-2xl mx-auto">
              ...
              <div
                className="flex flex-col gap-6 md:gap-8 opacity-0 animate-fade-in"
                style={{ animationDelay: "0.2s" }}
              >
                <div>
                  <Link
