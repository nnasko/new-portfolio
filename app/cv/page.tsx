        ...
        <div className={isPdfMode ? '' : 'space-y-12'}>
          ...
          <header className="space-y-4">
            ...
            <div className="flex gap-4 text-sm text-neutral-500 dark:text-neutral-400">
              <a href="mailto:me@atanaskyurkchiev.info" className="hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors">
                me@atanaskyurkchiev.info
              </a>
              <span>•</span>
              <a href="https://github.com/nnasko" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors">
                github.com/nnasko
              </a>
            </div>
          </header>
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-2">2024 - present</p>
                <ul className="space-y-2 text-sm">
                  <li>• leading development of a sustainable business supplies platform</li>
                  <li>• implementing complex inventory and order management systems</li>
                  <li>• integrating multiple third-party services (stripe, klaviyo, zedify)</li>
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-2">2024 - present</p>
                <ul className="space-y-2 text-sm">
                  <li>• developed and launched a custom e-commerce platform</li>
                  <li>• implemented secure payment processing and inventory management</li>
          ...
          <section>
            ...
            <div>
              <h3 className="text-sm mb-1">software development @ access creative college</h3>
              <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-2">2023 - 2025</p>
              <ul className="space-y-2 text-sm">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 text-sm">
              <div>
                <h3 className="text-neutral-500 dark:text-neutral-400 mb-2">languages</h3>
              ...
              <div>
                <h3 className="text-neutral-500 dark:text-neutral-400 mb-2">frameworks</h3>
                <ul className="space-y-1">
                  <li>• next.js</li>
                  <li>• react</li>
                  <li>• tailwind css</li>
              ...
              <div>
                <h3 className="text-neutral-500 dark:text-neutral-400 mb-2">tools</h3>
                <ul className="space-y-1">
                  <li>• git</li>
                  <li>• vs code</li>
                  <li>• figma</li>
