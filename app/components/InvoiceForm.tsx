...
export default function InvoiceForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage(`Invoice ${invoiceData.invoiceNumber} has been generated and sent to ${invoiceData.clientEmail}. A copy has been sent to your email as well.`);
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-lg font-mono lowercase">{invoiceData.invoiceNumber}</p>
          </div>
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="px-8 py-2 bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-900 rounded-full hover:bg-neutral-700 dark:hover:bg-neutral-200 transition-colors text-sm font-medium"
          >
            Generate Invoice
          </button>
        </div>
